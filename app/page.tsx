...
type Product = { id: number; name: string; desc: string; longDesc: string; price: number; type: string; image: string; images: string[] }
type CartItem = Product & { qty: number }

const products: Product[] = [
  { id:1, name:'Panno Microfibra Auto 500GSM', desc:'30x40cm — Pulizia perfetta, zero graffi sulla vernice', longDesc:'Dì addio ai graffi e agli aloni sulla carrozzeria. Il panno in microfibra professionale da 500GSM garantisce una pulizia perfetta, asciugatura rapida e zero danni alla vernice. Filamenti ultrasottili 1/10 della seta catturano polvere e particelle microscopiche. Antibatterico, anti-muffa e durata 4x superiore al cotone.', price:7.00, type:'fisico', image:'/images/panno1.jpg', images:['/images/panno1.jpg','/images/panno2.jpg'] },
  { id:2, name:'Pellicola Oscurante 90%', desc:'50x300cm — Blocca UV, privacy totale, anti-graffio', longDesc:'Trasforma il look della tua auto con la pellicola oscurante professionale al 90%. Blocca fino al 99% dei raggi UV, riduce il calore interno e garantisce privacy totale. Struttura multistrato anti-graffio, senza metalli pesanti, non interferisce con GPS o segnale cellulare. Facile da applicare, si ritaglia su misura.', price:49.99, type:'fisico', image:'/images/pellicola1.jpg', images:['/images/pellicola1.jpg','/images/pellicola2.jpg','/images/pellicola3.jpg'] },
  { id:3, name:'Kit Professionale Wrapping 14pz', desc:'Raschietti, taglierina, lame — tutto per pellicole', longDesc:'Il kit completo professionale per applicare pellicole oscuranti, fogli vinilici e carta da parati in modo preciso e senza errori. Include 2 raschietti in vinile con ricambi, micro raschietto a manico lungo, tagliavinile sicuro, taglierina di precisione con 5 lame di ricambio. Compatibile con pellicole oscuranti, car wrapping e decorazioni in vinile.', price:7.99, type:'fisico', image:'/images/kit1.jpg', images:['/images/kit1.jpg','/images/kit2.jpg'] },
]
        ...
        <div style={{ maxWidth:1000, margin:'0 auto', padding:'2rem' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:'3rem' }}>
            ...
            <div style={{ display:'flex', flexDirection:'column', justifyContent:'center' }}>
              ...
              <p style={{ fontSize:15, color:'#555', lineHeight:1.7, marginBottom:24 }}>{selectedProduct.longDesc}</p>
              ...
              <div style={{ fontSize:32, fontWeight:700, marginBottom:24, color:'#000' }}>€{selectedProduct.price.toFixed(2)}</div>
              ...
              <>
                ...
                <PayPalButtons
                  ...
                  onApprove={(data, actions) => {
                    return actions.order!.capture().then(() => { setPaid(true); setCart([]) })
                  }}
                />
              </>
            )}
